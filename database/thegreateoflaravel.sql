...
-- Dumping database structure for thegreatoflaravel
CREATE DATABASE IF NOT EXISTS `thegreatoflaravel` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
USE `thegreatoflaravel`;

-- Dumping structure for table thegreatoflaravel.banners
...
-- Dumping data for table thegreatoflaravel.banners: ~3 rows (approximately)
DELETE FROM `banners`;
...
-- Dumping structure for table thegreatoflaravel.brands
...
-- Dumping data for table thegreatoflaravel.brands: ~5 rows (approximately)
DELETE FROM `brands`;
...
-- Dumping structure for table thegreatoflaravel.carts
...
-- Dumping data for table thegreatoflaravel.carts: ~11 rows (approximately)
DELETE FROM `carts`;
INSERT INTO `carts` (`id`, `product_id`, `order_id`, `user_id`, `price`, `status`, `quantity`, `amount`, `created_at`, `updated_at`) VALUES
	...
	(12, 6, 6, 30, 5820.00, 'new', 1, 6000.00, '2024-11-30 21:30:14', '2024-11-30 23:19:29'),
	(13, 9, 7, 30, 190.00, 'new', 1, 190.00, '2024-12-01 08:28:03', '2024-12-01 08:30:28');

-- Dumping structure for table thegreatoflaravel.categories
...
-- Dumping data for table thegreatoflaravel.categories: ~7 rows (approximately)
...
-- Dumping structure for table thegreatoflaravel.coupons
...
-- Dumping data for table thegreatoflaravel.coupons: ~3 rows (approximately)
DELETE FROM `coupons`;
...
-- Dumping structure for table thegreatoflaravel.failed_jobs
...
-- Dumping data for table thegreatoflaravel.failed_jobs: ~0 rows (approximately)
DELETE FROM `failed_jobs`;

-- Dumping structure for table thegreatoflaravel.messages
...
-- Dumping data for table thegreatoflaravel.messages: ~3 rows (approximately)
DELETE FROM `messages`;
INSERT INTO `messages` (`id`, `name`, `subject`, `email`, `photo`, `phone`, `message`, `read_at`, `created_at`, `updated_at`) VALUES
	(1, 'Samer Amri', 'About price', 'amrisamer54@gmail.com', NULL, '9807009999', 'Hello sir i am from kathmandu nepal.', '2024-11-30 22:37:31', '2020-08-14 08:00:01', '2024-11-30 22:37:31'),
	(2, 'Samer Amri', 'About Price', 'amrisamer54@gmail.com', NULL, '9800099000', 'Hello i am Prajwal Rai', '2020-08-18 03:04:15', '2020-08-15 07:52:39', '2020-08-18 03:04:16'),
	(3, 'Samer Amri', 'lorem ipsum', 'amrisamer54@gmail.com', NULL, '1200990009', 'hello sir sdfdfd dfdjf ;dfjd fd ldkfd', '2024-12-01 08:24:30', '2020-08-17 21:15:12', '2024-12-01 08:24:30');

-- Dumping structure for table thegreatoflaravel.migrations
...
-- Dumping data for table thegreatoflaravel.migrations: ~20 rows (approximately)
...
-- Dumping structure for table thegreatoflaravel.notifications
...
-- Dumping data for table thegreatoflaravel.notifications: ~14 rows (approximately)
...
INSERT INTO `notifications` (`id`, `type`, `notifiable_type`, `notifiable_id`, `data`, `read_at`, `created_at`, `updated_at`) VALUES
	...
	('3e8ed4a7-a3ab-46ed-93ca-f71e3e7a668c', 'App\\Notifications\\StatusNotification', 'App\\User', 1, '{"title":"New order created","actionURL":"http:\\/\\/127.0.0.1:8000\\/admin\\/order\\/6","fas":"fa-file-alt"}', NULL, '2024-11-30 23:19:29', '2024-11-30 23:19:29'),
	...
	('d525fb2f-8e1a-4d19-b554-3fcf681a0a40', 'App\\Notifications\\StatusNotification', 'App\\User', 1, '{"title":"New order created","actionURL":"http:\\/\\/127.0.0.1:8000\\/admin\\/order\\/7","fas":"fa-file-alt"}', NULL, '2024-12-01 08:30:26', '2024-12-01 08:30:26'),
...
-- Dumping structure for table thegreatoflaravel.orders
...
-- Dumping data for table thegreatoflaravel.orders: ~6 rows (approximately)
DELETE FROM `orders`;
INSERT INTO `orders` (`id`, `order_number`, `user_id`, `sub_total`, `shipping_id`, `coupon`, `total_amount`, `quantity`, `payment_method`, `payment_status`, `status`, `first_name`, `last_name`, `email`, `phone`, `country`, `post_code`, `address1`, `address2`, `created_at`, `updated_at`) VALUES
	...
	(6, 'ORD-CP6JFWR7TB', 30, 6000.00, NULL, 300.00, 5700.00, 1, 'cod', 'unpaid', 'delivered', 'samer', 'amri', 'amrisamer54@gmail.com', '0771015418', 'DZ', NULL, 'Biskra', NULL, '2024-11-30 23:19:27', '2024-11-30 23:20:59'),
	(7, 'ORD-XSWXLAHUTO', 30, 190.00, NULL, 300.00, -110.00, 1, 'cod', 'unpaid', 'new', 'samer', 'amri', 'amrisamer54@gmail.com', '0771015418', 'DZ', NULL, 'Biskra', NULL, '2024-12-01 08:30:24', '2024-12-01 08:30:24');

-- Dumping structure for table thegreatoflaravel.password_resets
...
-- Dumping data for table thegreatoflaravel.password_resets: ~0 rows (approximately)
DELETE FROM `password_resets`;

-- Dumping structure for table thegreatoflaravel.posts
...
-- Dumping data for table thegreatoflaravel.posts: ~5 rows (approximately)
DELETE FROM `posts`;
...
-- Dumping structure for table thegreatoflaravel.post_categories
...
-- Dumping data for table thegreatoflaravel.post_categories: ~5 rows (approximately)
...
-- Dumping structure for table thegreatoflaravel.post_comments
...
-- Dumping data for table thegreatoflaravel.post_comments: ~7 rows (approximately)
...
-- Dumping structure for table thegreatoflaravel.post_tags
...
-- Dumping data for table thegreatoflaravel.post_tags: ~4 rows (approximately)
...
-- Dumping structure for table thegreatoflaravel.products
...
-- Dumping data for table thegreatoflaravel.products: ~10 rows (approximately)
...
-- Dumping structure for table thegreatoflaravel.product_reviews
...
-- Dumping data for table thegreatoflaravel.product_reviews: ~2 rows (approximately)
...
-- Dumping structure for table thegreatoflaravel.settings
...
-- Dumping data for table thegreatoflaravel.settings: ~0 rows (approximately)
DELETE FROM `settings`;
INSERT INTO `settings` (`id`, `description`, `short_des`, `logo`, `photo`, `address`, `phone`, `email`, `created_at`, `updated_at`) VALUES
	(1, '<p>Discover My case platform that is user-friendly platform bridges the gap between clients and lawyers, offering seamless case management, real-time communication, and easy access to legal services. Clients can search for attorneys, schedule consultations, and track case progress with ease. Lawyers, on the other hand, can manage their cases, access legal resources, and stay connected with clients efficiently. Coordinated with the National Bar Association, the platform ensures compliance, transparency, and professionalism in all interactions. Behind the scenes, a central admin oversees user management, service quality, and legal updates, ensuring a smooth and secure experience for all participants.</p>', 'My Case is An&nbsp;Establishment of a National Digital Platform in coordination with the National Bar Association', '/storage/photos/1/logo5.png', '/storage/photos/1/blog3.jpg', 'Biskra, Algeria', '+213771015418', 'mycase@gmail.com', NULL, '2024-12-05 01:42:15');

-- Dumping structure for table thegreatoflaravel.shippings
...
-- Dumping data for table thegreatoflaravel.shippings: ~4 rows (approximately)
...
-- Dumping structure for table thegreatoflaravel.users
...
-- Dumping data for table thegreatoflaravel.users: ~16 rows (approximately)
DELETE FROM `users`;
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `photo`, `role`, `provider`, `provider_id`, `status`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 'Samer Amri', 'admin@gmail.com', NULL, '$2y$10$GOGIJdzJydYJ5nAZ42iZNO3IL1fdvXoSPdUOH3Ajy5hRmi0xBmTzm', '/storage/photos/1/download.png', 'admin', NULL, NULL, 'active', 'l6hHk5e0TA4ps07Zzoy5tdixKNv3cjmsJapFl0IQMvGyJykxlMobAnR7Girr', NULL, '2024-11-30 20:09:47'),
	(2, 'User', 'user@gmail.com', '2024-12-05 03:53:42', '$2y$10$10jB2lupSfvAUfocjguzSeN95LkwgZJUM7aQBdb2Op7XzJ.BhNoHq', '/storage/photos/1/users/user2.jpg', 'user', NULL, NULL, 'active', NULL, NULL, '2020-08-15 07:30:07'),
	...
	(30, 'Samer Amri', 'amrisamer54@gmail.com', NULL, '$2y$10$WWoXyIR8FsP7vNnO1o2tfOYkbeSPBP8JkROwq9kh8mZb14ExziZDC', NULL, 'user', NULL, NULL, 'active', NULL, '2024-11-30 20:46:36', '2024-11-30 20:46:36'),
	(31, 'hana', 'bensaidhana@gmail.com', NULL, '$2y$10$a1E0MiRZUiyjJVICwKy5euMv2NTUHskXpvA8HUUr/gzDkDAADkIlS', NULL, 'user', NULL, NULL, 'active', NULL, '2024-12-01 08:25:46', '2024-12-01 08:25:46');

-- Dumping structure for table thegreatoflaravel.wishlists
...
-- Dumping data for table thegreatoflaravel.wishlists: ~0 rows (approximately)
