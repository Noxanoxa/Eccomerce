...
function App() {
  ...
  */
  ...
  const addToCart = (product) => {
    ...
    if (productExit) {
      setCartItem(CartItem.map((item) => (item.code === product.code ? { ...productExit, qty: productExit.qty + 1 } : item)))
    } else {
      ...
      <Router>
        ...
        <Switch>
          ...
          <Route path='/cart' exact>
            <Cart CartItem={CartItem} setCartItem={setCartItem} addToCart={addToCart} decreaseQty={decreaseQty} />
          </Route>
